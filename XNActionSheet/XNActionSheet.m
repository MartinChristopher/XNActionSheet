...
#import "XNActionSheet.h"
#import "XNButton.h"
#import "UIView+XNActionSheet.h"
...
@implementation XNActionSheet

static XNButton *bgView;
...
+ (void)showActionWithTitles:(NSArray *)actionTitle
    ...
    // 取消
    XNButton *cancleBtn = [[XNButton alloc] init];
    ...
    for (NSUInteger i = 0; i<actionTitle.count; i++) {
        ...
        XNButton *btn = [[XNButton alloc] init];
